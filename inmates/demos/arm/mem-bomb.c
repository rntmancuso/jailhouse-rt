...
void inmate_main(void)
{
	...
	jailhouse_call_arg1(JAILHOUSE_HC_TRANS_DEBUG, (unsigned long)buffer);

	jailhouse_call_arg1(JAILHOUSE_HC_TRANS_DEBUG, (unsigned long)0x7500000UL);
	jailhouse_call_arg1(JAILHOUSE_HC_TRANS_DEBUG, (unsigned long)0x6500000UL);
